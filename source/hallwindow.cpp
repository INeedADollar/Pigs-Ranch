    ...
    ui(new Ui::HallWindow)
{
    ...
    QObject::connect(ui->pushButton, &QPushButton::clicked, this, &HallWindow::showHallStatistics);
}
...
void HallWindow::showHallStatistics(){
    pigsHall->showHallStatistics();
}

void HallWindow::resizeEvent(QResizeEvent *event){
    ...
    QPoint buttonPoint = QPoint(ui->pushButton->x(), newSize.height() - 51);
    ui->pushButton->move(buttonPoint);
}
/*******************************************************************/
...
void HallBluePrintWidget::resizeEvent(QResizeEvent *event){
    resizeBoxes();
}
/**********************************************************************/
